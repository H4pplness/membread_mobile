...
class ChooseAnswerOption extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final choiceStates = ref.watch(testChoiceNotifierProvider);
    return Container(
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  onTap: () async {
                    print("CHOOSE... ");
                    ref.read(testChoiceNotifierProvider.notifier).choose(index);
                    ...
                    ref.read(testChoiceNotifierProvider.notifier).resetChoice();
                  },
                  child: Container(
